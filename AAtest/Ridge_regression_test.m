...
%if ~ismember(at,aa(1,:))
mex -v m_ridge_regression_train.cpp daal_core.lib daal_thread.lib
...
for i=1:10
    ...
    [xtr,ytr,coeff,bias]=sample_regression(npts,nfeatures,[-10 10],[-10 10],[-10 10],0.1);
    ...
    for j=1:rptimes
        [opw,opb]=m_ridge_regression_train(xtr,ytr,ridgepara);
    end
